...
namespace PizzaBox.Data.Migrations
{
    ...
    [Migration("20190830045533_origin")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzaBox.Domain.Models.User", b =>
                {
                    ...
                    b.Property<int?>("LatestLocationId");

                    b.Property<int?>("NameId");

                    b.Property<int?>("checklocationLocationId");
                    ...
                    b.HasIndex("LatestLocationId");

                    b.HasIndex("NameId");

                    b.HasIndex("checklocationLocationId");
            ...
            modelBuilder.Entity("PizzaBox.Domain.Models.User", b =>
                {
                    b.HasOne("PizzaBox.Domain.Models.Account", "Account")
                        .WithMany()
                    ...
                    b.HasOne("PizzaBox.Domain.Models.Location", "Latest")
                        .WithMany()
                        .HasForeignKey("LatestLocationId");

                    b.HasOne("PizzaBox.Domain.Models.Name", "Name")
                        .WithMany()
                        .HasForeignKey("NameId");

                    b.HasOne("PizzaBox.Domain.Models.Location", "checklocation")
                        .WithMany()
                        .HasForeignKey("checklocationLocationId");
                });
